...
class Teamlead_model extends MY_Model
{
	public $table = "users";
	private $CI;
	...
	public function assignintern($vid,$listid,$intername,$startrec,$endrec,$tlid,$deadline)
	{
		...
		$qwe=$this->db->query("INSERT INTO intern_lists( list_id,list_name, intern_name, start_rec, end_rec, intern_id,deadline) VALUES('$listid','$list_name','$intername','$startrec','$endrec','$internid')");
		$historystore=$this->db->query("INSERT INTO intern_history( list_id, intern_id, tl_id, date_assigned) VALUES('$listid','$internid','$tlid','$date','$deadline')");
