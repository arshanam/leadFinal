...
class DOMPDF {
  ...
  function __construct() {
    ...
    require_once("frame_tree.cls.php");
    require_once("stylesheet.cls.php");
    require_once("frame_factory.cls.php");
     require_once("abstract_renderer.cls.php");
     require_once("renderer.cls.php");
     require_once("canvas.cls.php");
     require_once("cpdf_adapter.cls.php");
   require_once("canvas_factory.cls.php");
      require_once("image_cache.cls.php");
